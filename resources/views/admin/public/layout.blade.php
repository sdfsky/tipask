            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="../../index.html"><i class="fa fa-circle-o"></i>站点设置</a></li>
                        <li><a href="../../index2.html"><i class="fa fa-circle-o"></i>时间设置</a></li>
                        <li><a href="../../index2.html"><i class="fa fa-circle-o"></i>邮件设置</a></li>
                        <li><a href="../../index2.html"><i class="fa fa-circle-o"></i>防灌水设置</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('/admin_user/create') }}"><i class="fa fa-circle-o"></i>添加用户</a></li>
                        <li><a href="{{ url('/admin_user/index') }}"><i class="fa fa-circle-o"></i>用户管理</a></li>
                        <li><a href="../layout/boxed.html"><i class="fa fa-circle-o"></i>用户组管理</a></li>
