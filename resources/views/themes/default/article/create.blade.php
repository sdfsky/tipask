        ...
        <div class="col-md-12 main widget-form">
            <form id="article_form" method="POST" role="form" enctype="multipart/form-data" action="{{ route('blog.article.store') }}">
                ...
                <div class="form-group @if($errors->has('title')) has-error @endif ">
                    ...
                    <input id="title" type="text" name="title"  class="form-control input-lg" placeholder="我想起那天下午在夕阳下的奔跑,那是我逝去的青春" value="{{ old('title',$formData['subject']) }}" />
                ...
                <div class="row mt-20">
                    ...
                    <div class="col-xs-12 col-md-2">
                        <input type="hidden" id="article_editor_content"  name="content" value="{{ old('content',$formData['content']) }}"  />
            ...
            $('#article_editor').summernote({
                ...
                callbacks: {
                    onChange:function (contents, $editable) {
                        ...
                        $.post("{{ route('auth.draft.create',['type'=>'article']) }}",$("#article_form").serialize(),function(msg){
