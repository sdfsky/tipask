        ...
        <form id="questionForm" method="POST" role="form" action="{{ route('ask.question.store') }}">
            ...
            <div class="row mt-20">
                ...
                <div class="col-md-4">
                    ...
                    <button type="button" class="btn btn-primary pull-right editor-submit" data-form_id="#questionForm" data-field_id="#editor_content" data-editor_id="#question_editor">发布问题</button>
                </div>
            </div>
        </form>
